...
\includegraphics[width=5mm, height=5mm]{web.png}& \href{https://kevin.ubbedigital.com}{\textcolor{Blue}{kevin.ubbedigital.com}}\\
...
\includegraphics[width=5mm, height=5mm]{linkedin.png}& \href{https://www.linkedin.com/in/kevin-rojas-}{\textcolor{Blue}{in/kevin-rojas}}\\
...
\resumeSubHeadingListStart
	...
	\resumeSubItem{Lenguajes}{~~~~~~~~~~~~~~~~~~Python, C, Assembly(PIC), JavaScript, TypeScript}
	\resumeSubItem{Frameworks}{~~~~~~~~~~~~~~~Odoo, Angular, Django, Flask, Ionic}
	\resumeSubItem{Herramientas}{~~~~~~~~~~~~~GIT, PostgreSQL, MySQL, \LaTeX{}}
	\resumeSubItem{Plataformas}{~~~~~~~~~~~~~~~GNU/Linux Debian, Arduino, AWS, Heroku}
	\resumeSubItem{MicroControladores}{~~~PICs, ESP8266 nodeMCU, ESP32}
	\resumeSubItem{Soft Skills}{~~~~~~~~~~~~~~~~~~IoT, HTML, CSS}
	\resumeSubItem{Protocolos}{~~~~~~~~~~~~~~~~~$I^{2}C$, SPI, UART, MQTT, Modbus TCP-IP}
...
\vspace{2pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{Yeet C.A.}{Remoto (Tiempo parcial)}
    {Odoo Developer}{Abr 2021 - Presente}
    \resumeItemListStart
        \resumeItem{Desarrollo en Odoo EE}
          {Programación y desarrollo en Odoo Enterprise v14.}
        \resumeItem{Tecnologías y herramientas usadas}{GIT, Pycharm, Odoo.sh, API REST}
      \resumeItemListEnd
      
      \vspace{10pt}   
      
    \resumeSubheading{4Plus Ingenieros y Arquitectos S.L.}{Remoto (Tiempo completo)}
    {Colaborador informático}{Ene 2021 - Presente}
    \resumeItemListStart
    
     	\resumeItem{Desarrollo en Odoo CE}
          {Programación y desarrollo en Odoo Community v11 y v14.}
        \resumeItem{Desarrollo en Angular y Node}
          {Programación en Nodejs y Angular v11}
         \resumeItem{Programación en Php}
          {Programación en PHP v7.}
          \resumeItem{Tecnologías y herramientas usadas}{GIT, VScode, Pycharm, Ubuntu, API REST, MySQL, MongoDB, TypeScript}
      \resumeItemListEnd
\vspace{10pt}   
  
  
    \resumeSubheading{Edooit C.A.}{Remoto (Tiempo parcial)}
    {Analista de Proyectos}{Abr 2020 - Presente}
    \resumeItemListStart
        \resumeItem{Desarrollo en Odoo CE}
          {Creación, programación y mantenimiento de módulos en Odoo CE v11 y v13}
          ...
          \resumeItem{Tecnologías y herramientas usadas}{GIT, Python, XML, XML-RPC, JSON-RPC, VScode, Pycharm, Debian, API REST, Virtual env, PostgreSQL, Javascript}
      \resumeItemListEnd
\vspace{10pt}
    \resumeSubheading
...
\resumeItemListStart
        \resumeItem{Programación de Microcontroladores}
          ...
          \resumeItem{Tecnologías y herramientas usadas}{PICs (Gama media/alta), C, Arduino, ESP8266, Mplab X IDE, FreeRTOS.}
      \resumeItemListEnd
