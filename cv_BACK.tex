...
~~
  ...
  \begin{tabular}{l r}
 \includegraphics[width=3.3cm, height=4cm]{perfil.jpg}
\end{tabular}
...
\resumeSubHeadingListStart
	...
	\resumeSubItem{Lenguajes}{~~~~~~~~~~~~~~~~~~Python, C, Assembly(PIC), Java, JavaScript, TypeScript}
	\resumeSubItem{Frameworks}{~~~~~~~~~~~~~~~Odoo, Django, Flask, React, Ionic 4, Angular 9, Spring Boot}
...
\vspace{2pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{4Plus Ingenieros y Arquitectos S.L.}{Remoto}
    {Colaborador informático | Desarrollador Backend - Frontend}{Ene 2021 - Presente}
    \resumeItemListStart
        \resumeItem{Desarrollo en Angular y Node}
          {Programación en Angular v11.}
        \resumeItem{Desarrollo en Odoo}
          {Programación y desarrollo en Odoo v13 y v14.}
...
\vspace{10pt}   
    ...
    \resumeItemListStart
        \resumeItem{Desarrollo en Odoo}
          ...
          \resumeItem{Tecnologías y herramientas usadas}{GIT, XML-RPC, JSON-RPC, VScode, Pycharm, Debian, API REST, Virtual env.}
      \resumeItemListEnd
\vspace{10pt}
    \resumeSubheading
